 ...
 */
@Experimental
class FPGrowthModel[Item: ClassTag](val freqItemsets: RDD[FreqItemset[Item]], val freqItems: Array[Item]) extends Serializable
...
class FPGrowth private (
  ...
  def run[Item: ClassTag](data: RDD[Array[Item]]): FPGrowthModel[Item] = {
    ...
    /**
     * Use the minimum support as absolute number rather than the percentage points.
     */
    val minCount = math.ceil(minSupport * 1).toLong 
